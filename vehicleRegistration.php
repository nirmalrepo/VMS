...
<html>
    ...
    <body style="background-color: rgba(237, 237, 237, 0.64)">
        <div id="wrap">
            <?php require_once './include/navBar.php'; ?>
            <div class="container-fluid">
                <!--<div class="row">-->
                <div class="col-md-12" style="margin-top: 78px;">
                    <div class="page-header header_1" style="margin-left: -15px; margin-right: -15px; margin-top: -65px;">

                        <h3><span class="rcrnr">Vehicle Registration<small style="color: white;font-weight: 200">&nbsp;&nbsp;Manage Vehicle Information</small></span></h3>
                    </div>
                    <div class="row" id="main_row">
                        <div class="col-md-9" style="padding-top: 17px">
                            <div>
                                <div class="row">
                        ...
                        <div class="col-md-3"style="padding-top: 7px">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <button type="button" id="imguploader_btn" class="btn btn-block btn-primary" data-toggle="modal" data-target="#model3" style="margin-top: 5px;">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="form-horizontal">
                                    <div class="col-md-8">
                                        <div class="panel panel-primary give_border" style="border:none">
                                            <div class="panel-heading" id="panhead" style="background-color: rgba(158, 158, 158, 0.59);border:none">
                                                <h3 class="panel-title new_table"><span class="table_head1">Registered Vehicles</span></h3>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table modal_table table-striped table-hover" id="table2" style="">
                            <thead>
                            </thead>
                            <tbody> 
                            </tbody>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#panhead').click(function () {
                ...
                $('.give_border').css('border-color', 'rgba(158, 158, 158, 0.59)');
