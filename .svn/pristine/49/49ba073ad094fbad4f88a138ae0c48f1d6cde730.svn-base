                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="scrollable" style="height: 350px; overflow-y: auto">
                                            <table class="table table-bordered table-striped table-hover datable vehicle_repair_data_table hidden" id="table2">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th class="thead">Reg.No.</th>
                                                        <th>Date</th>
                                                        <th>Comment</th>                                                                   
                                                        <th>Place</th>
                                                        <th>Cost</th>
                                                        <th class="thead1">Action</th>
                                                        <!--<th></th>-->
                                                    </tr>
                                                </thead>
                                                <tbody>                                                             
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#generate_repair_forms_btn').click(function () {
                ...
                generate_repair_table(branchCombo, regCombo, i);
